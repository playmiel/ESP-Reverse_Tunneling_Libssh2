...
private:
  ...
  static constexpr unsigned long DRAIN_TIMEOUT_MS = 5000; // Max time in Draining state
  static constexpr unsigned long HALF_CLOSE_TIMEOUT_MS = 3000; // Close after remote EOF + 3s idle
  static constexpr int EAGAIN_STALL_TIMEOUT_MS = 10000;  // Max EAGAIN duration before close
